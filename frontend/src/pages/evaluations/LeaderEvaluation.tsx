...
const LeaderEvaluation = () => {
  ...
  useEffect(() => {
    ...
    if (!storageKey || hasExistingEvaluation || viewMode === 'view' || sections.length === 0) return;
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      {selectedEmployeeId && isLoadingEmployee && (
        ...
        >
          <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-top-teal dark:border-top-teal mx-auto mb-4"></div>
