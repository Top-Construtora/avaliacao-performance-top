...
const NotificationHistory: React.FC = () => {
  ...
  const allNotifications: Notification[] = [
    ...
    },
    {
      ...
      type: 'promotion',
      title: 'Nova Promoção',
      message: 'João Silva foi promovido para Analista Sênior após excelente desempenho no último ciclo',
    ...
    },
    {
      ...
      message: 'Lucas Pereira foi reposicionado na matriz: Alto Potencial / Alto Desempenho',
