...
const RegisterUser = () => {
  ...
  /* Validação por passo do wizard. Cada função computa só os erros dos seus
     campos e mescla no estado (preservando erros de outros passos); devolve
     true quando o passo pode avançar. */
  ...
  const validateStepPessoais = () => {
    ...
    return mergeErrors(['name', 'email', 'password', 'phone', 'birthDate', 'joinDate'], errors);
  };
  ...
  const validateStepCarreira = () => {
    ...
    return mergeErrors(['departmentId', 'trackId', 'positionId', 'internLevel'], errors);
  };
  ...
  const validateStepEquipe = () => {
    ...
    return mergeErrors(['teams', 'reportsTo'], errors);
  };

  const validateForm = () => {
    // Ordem importa: valida tudo e reporta o conjunto completo
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      {/* Cadastro em 4 passos (FormWizard) — a validação de cada etapa roda
          ao avançar; o salvar final revalida tudo. */}
      <FormWizard
        onFinish={handleSubmit}
        finishing={isLoading}
        finishLabel="Salvar Usuário"
        ...
        steps={[
          {
            ...
            content: (
              <>
                ...
                <motion.div className="bg-card rounded-2xl p-4 sm:p-6 shadow-sm dark:shadow-lg border border-border">
                    ...
                    <div className="flex items-center justify-between p-4 bg-secondary rounded-xl">
                      <div className="pr-4">
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          ...
                          colaborador, administradores, diretores e o líder direto. Demais usuários
                          veem uma versão genérica no formato &quot;Cargo de Time&quot;.
                        </p>
                      </div>
                      <button
                        type="button"
