 ...
 return (
   <div className="space-y-4 md:space-y-6">
     ...
     >
       ...
       {/* Progress Overview */}
       <div className="bg-gradient-to-r from-primary-50 via-secondary-50 to-accent-50 rounded-lg md:rounded-xl p-3 md:p-4 border border-primary-100">
         <div className="flex flex-col space-y-3 md:flex-row md:items-center md:justify-between md:space-y-0">
           <div className="flex items-center space-x-2 md:space-x-3">
             <Calendar className="h-4 w-4 md:h-5 md:w-5 text-primary-600 flex-shrink-0" />
             <span className="text-sm md:text-base font-medium text-gray-700">Ciclo de Avaliação 2024</span>
           </div>
           <div className="flex items-center justify-between md:space-x-6">
             <div className="text-left md:text-right">
               <p className="text-xs md:text-sm text-gray-600">Progresso Geral</p>
               <p className="text-xl md:text-2xl font-bold text-primary-600">{Math.round(progressPercentage)}%</p>
             </div>
             <div className="w-24 md:w-32 bg-gray-200 rounded-full h-2 md:h-3">
               <div 
                 className="h-2 md:h-3 rounded-full bg-gradient-to-r from-primary-500 to-primary-600 transition-all duration-500"
