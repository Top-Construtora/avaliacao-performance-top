      ...
      >
        <div className="flex items-start space-x-6">
          <div className="relative">
            <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-primary-500 to-secondary-600 flex items-center justify-center text-white text-2xl font-bold shadow-lg">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <span className="text-xs text-gray-500 mt-1">Baixar suas informações</span>
          </Button>
          ...
          >
            ...
            <span className="text-xs text-gray-500 mt-1">Restaurar configurações</span>
          </Button>
          ...
          >
            ...
            <span className="text-xs text-red-500 mt-1">Ação irreversível</span>
          </Button>
        </div>
      </motion.div>
    </div>
